...
# Create routes
Route::get('/students/create', [StudentController::class, 'giveCreateForm'])->name('student.showCreateForm');
Route::post('/students', [StudentController::class, 'createSingle'])->name('student.toCreate');

# Delete routes
Route::get('/students/delete/{id}', [StudentController::class, 'giveDeleteForm'])->name('student.showDeleteForm');
Route::delete('/students/{id}', [StudentController::class, 'deleteSingle'])->name('student.toDelete');

# Update routes
Route::get('/students/update/{id}', [StudentController::class, 'giveUpdateForm'])->name('student.showUpdateForm');
